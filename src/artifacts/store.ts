...
import { isSupabaseEnabled, dbSaveArtifact } from "../integrations/supabase.js";
import type { Artifact, IngestInput, RouterTag } from "./types.js";
...
export function versionArtifact(
  ...
  const lineage = listArtifacts({ brand: orig.brand }).filter(
